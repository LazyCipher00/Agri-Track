    ...
    <div style={{ minHeight: '100vh', background: '#f4efe6', fontFamily: "'DM Sans', sans-serif", overflowX: 'hidden', color: '#0d1f0f' }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .at-nav.scrolled .nav-admin { color: var(--text-muted); opacity: 0.6; }
        .nav-admin:hover { color: #fff; opacity: 0.9; }
        .at-nav.scrolled .nav-admin:hover { color: var(--green-deep); opacity: 0.8; }
      ...
      <nav className={`at-nav ${scrolled ? 'scrolled' : ''}`}>
        <div className="at-nav-inner">
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
            ...
            <button className="nav-admin" onClick={() => onNavigate('admin-login')}>Admin</button>
